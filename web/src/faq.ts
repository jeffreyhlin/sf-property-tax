...
export const FAQ: FaqItem[] = [
  ...
  {
    "q": "So is \"likely relational transfer\" a fact?",
    "a": "No, it's an inference. We don't have the recorded deeds, so we can't say who transferred to whom or under which exclusion. Some edge cases, like certain co-owner buyouts or legal entity changes, can look the same in the data. That's why the label says \"likely.\""
  },
  {
  ...
  },
  {
    ...
    "a": "The site shows addresses, taxed values, and estimates, all derived from public open data, and no owner names. We publish it because who benefits from Prop 13, and by how much, is a public policy question, and the underlying records have always been public. We aim the spotlight at the system, not at any one household."
  },
  {
    "q": "Can I get my property removed?",
    "a": "If you're an individual, yes. Email us from an address you can verify, tell us the parcel, and we'll exclude it from the map and leaderboards. Following the SF Chronicle's approach with its Prop 13 project, this applies to people, not to companies, LLCs, or landlords of multi-unit buildings."
  },
  {
    "q": "Where does the data come from, and how often does it update?",
    "a": "Two DataSF open datasets: the Assessor's historical secured tax rolls (2007 to present) and the city's parcel map. The assessor roll is published once a year after the roll closes, and we rebuild the site when a new roll lands. The map currently covers a few neighborhoods, not the whole city."
  },
  {
    "q": "Is this legal?",
